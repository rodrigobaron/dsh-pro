...
export function AtFileSection({
  ...
  return (
    <section className="dsh_atFile_section" aria-labelledby="at-file-settings-title">
      <h2 id="at-file-settings-title" className="dsh_atFile_title">{t('settings.title')}</h2>
      ...
      <div className="dsh_atFile_filter">
        ...
        <div className="dsh_atFile_filterAddRow">
          <input
            ...
            aria-describedby="at-file-filter-message"
